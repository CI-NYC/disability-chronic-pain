...
psi_oud_hillary <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_hillary_sens_pain.rds"))
psi_oud <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_sens_pain.rds"))
psi_oud_poison <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_poison_sens_pain.rds"))
...
ggsave(here::here("projects/create_cohort/figures/sens_results_pain.pdf"), height=7.5, width=7.5)
