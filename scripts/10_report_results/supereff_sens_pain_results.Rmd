...
psi_oud_hillary <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_hillary_sens_pain_supereff.rds"))
psi_oud <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_sens_pain_supereff.rds"))
psi_oud_poison <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_poison_sens_pain_supereff.rds"))
...
ggsave(here::here("projects/create_cohort/figures/supereff_sens_results_pain.pdf"), height=7.5, width=7.5)
