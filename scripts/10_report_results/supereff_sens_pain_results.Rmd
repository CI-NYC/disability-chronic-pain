---
title: "SUPEREFF sensitivity results 1: pain as exposure group"
...
psi_oud_hillary <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_hillary_sens_pain_supereff_92623.rds"))
psi_oud <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_sens_pain_supereff_92623.rds"))
psi_oud_poison <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_poison_sens_pain_supereff_92623.rds"))
...
contrast_list <- list(
    c("Disability and pain", "Disability only"),
    c("Disability and pain", "Pain only"),
    c("Disability and pain", "Neither"),
...
all_res |>
    ...
    tab_header("Incidence estimates",
               subtitle ="Sensitivity exposure (pain)")
...
p_est <-
    ...
    mutate(est = est * 100,
           low = low * 100,
           high = high * 100,
           shift = fct_rev(fct_relevel(shift, "Disability and pain", "Pain only")),
...
p_neither <- 
    ...
    mutate(theta = theta * 100,
           ...
           shift = fct_relevel(fct_recode(factor(shift),
                              "Disability and pain\n vs. neither" = "Disability and pain",
...
p_cont <-
    ...
    mutate(theta = theta * 100,
        ...
        ref = fct_recode(factor(ref),
           ...
           "Disability and pain\n vs. pain only" = "Pain only"),
           # ref = fct_relevel(ref, "Disability and pain\n vs. pain only"),
           outcome = fct_relevel(outcome, "OUD (ICD codes)", "OUD (composite)")) |>
    filter(shift != "Null") |>
...
ggsave(here::here("projects/create_cohort/figures/supereff_sens_results_pain.jpg"), height=7.5, width=7.5)
