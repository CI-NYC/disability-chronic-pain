...
psi_cp <- read_rds(here::here("projects/create_cohort/output/psis/psi_cp.rds"))
psi_anxiety <- read_rds(here::here("projects/create_cohort/output/psis/psi_anxiety.rds"))
psi_depression <- read_rds(here::here("projects/create_cohort/output/psis/psi_depression.rds"))
psi_opioids <- read_rds(here::here("projects/create_cohort/output/psis/psi_opioids.rds"))
