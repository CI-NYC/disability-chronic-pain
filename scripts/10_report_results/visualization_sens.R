...
td <- "projects/create_cohort/output/psis/"
list.files(td)

psi_oud_hillary <- read_rds(here::here(td, "psi_oud_hillary_sens_12mos_noearth.rds"))
psi_oud <- read_rds(here::here(td, "psi_oud_poison_sens_12mos.rds"))
