...
psi_oud_hillary <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_hillary_sens_12mos_supereff.rds"))
...
ggsave(here::here("projects/create_cohort/figures/supereff_sens_results_12mos.pdf"), height=7.5, width=7.5)
