---
title: "SUPEREFF sensitivity results 2: 12months CP as exposure group"
...
psi_oud_hillary <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_hillary_sens_12mos_supereff_92623.rds"))
psi_oud <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_sens_12mos_supereff.rds"))
psi_oud_poison <- read_rds(here::here("projects/create_cohort/output/psis/psi_oud_poison_sens_12mos_supereff.rds"))
...
ggsave(here::here("projects/create_cohort/figures/supereff_sens_results_12mos.jpg"), height=7.5, width=7.5)
