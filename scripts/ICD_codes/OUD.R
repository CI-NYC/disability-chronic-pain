################################################################################
################################################################################
### ICD10 Codes to Source for OUD Diagnosis
### Goes with 06_define_OUD.R
...
mcneely_codes_abuse <-
  c(
    ...
    "F1199",    # OPIOID USE, UNSP WITH UNSPECIFIED OPIOID-INDUCED DISORDER
    "F1199",    # OPIOID USE, UNSP WITH UNSPECIFIED OPIOID-INDUCED DISORDER
    # start of AE, note the 8 flagged codes
    ...
    "T401X2S",    # POISONING BY HEROIN, INTENTIONAL SELF-HARM, SEQUELA
    "T401X3",    # POISONING BY HEROIN, ASSAULT
    ...
    "T401X4S",    # POISONING BY HEROIN, UNDETERMINED, SEQUELA
    "T402X",    # POISONING BY, ADVERSE EFFECT OF AND UNDERDOSING OF OPIOIDS
    "T402X1",    # POISONING BY OTHER OPIOIDS, ACCIDENTAL (UNINTENTIONAL)
    "T402X1A",    # POISONING BY OTH OPIOIDS, ACCIDENTAL (UNINTENTIONAL), INIT
    "T402X1A",    # POISONING BY OTH OPIOIDS, ACCIDENTAL (UNINTENTIONAL), INIT
    "T402X1D",    # POISONING BY OTH OPIOIDS, ACCIDENTAL (UNINTENTIONAL), SUBS
    "T402X1D",    # POISONING BY OTH OPIOIDS, ACCIDENTAL (UNINTENTIONAL), SUBS
    "T402X1S",    # POISONING BY OTH OPIOIDS, ACCIDENTAL, SEQUELA
    "T402X1S",    # POISONING BY OTH OPIOIDS, ACCIDENTAL, SEQUELA
    "T402X2",    # POISONING BY OTHER OPIOIDS, INTENTIONAL SELF-HARM
    "T402X2A",    # POISONING BY OTH OPIOIDS, INTENTIONAL SELF-HARM, INIT ENCNTR
    "T402X2A",    # POISONING BY OTH OPIOIDS, INTENTIONAL SELF-HARM, INIT ENCNTR
    "T402X2D",    # POISONING BY OTH OPIOIDS, INTENTIONAL SELF-HARM, SUBS ENCNTR
    "T402X2D",    # POISONING BY OTH OPIOIDS, INTENTIONAL SELF-HARM, SUBS ENCNTR
    "T402X2S",    # POISONING BY OTHER OPIOIDS, INTENTIONAL SELF-HARM, SEQUELA
    "T402X2S",    # POISONING BY OTHER OPIOIDS, INTENTIONAL SELF-HARM, SEQUELA
    "T402X3",    # POISONING BY OTHER OPIOIDS, ASSAULT
    ...
    "T402X4A",    # POISONING BY OTHER OPIOIDS, UNDETERMINED, INITIAL ENCOUNTER
    "T402X4D",    # POISONING BY OTHER OPIOIDS, UNDETERMINED, SUBS ENCNTR
    "T402X4D",    # POISONING BY OTHER OPIOIDS, UNDETERMINED, SUBS ENCNTR
    "T402X4S",    # POISONING BY OTHER OPIOIDS, UNDETERMINED, SEQUELA
    "T402X4S",    # POISONING BY OTHER OPIOIDS, UNDETERMINED, SEQUELA
    "T402X5",    # ADVERSE EFFECT OF OTHER OPIOIDS
    ...
    "T403X1A",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), INIT
    "T403X1A",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), INIT
    "T403X1D",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), SUBS
    "T403X1D",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), SUBS
    "T403X1S",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), SEQUELA
    "T403X1S",    # POISONING BY METHADONE, ACCIDENTAL (UNINTENTIONAL), SEQUELA
    "T403X2",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM
    "T403X2A",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, INIT ENCNTR
    "T403X2A",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, INIT ENCNTR
    "T403X2D",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, SUBS ENCNTR
    "T403X2D",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, SUBS ENCNTR
    "T403X2S",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, SEQUELA
    "T403X2S",    # POISONING BY METHADONE, INTENTIONAL SELF-HARM, SEQUELA
    "T403X3",    # POISONING BY METHADONE, ASSAULT
    ...
    "T403X4S",    # POISONING BY METHADONE, UNDETERMINED, SEQUELA
    "T403X5",    # ADVERSE EFFECT OF METHADONE
    ...
    "T403X5S",    # ADVERSE EFFECT OF METHADONE, SEQUELA
    "T404X1",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL
    "T404X1A",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, INIT
    "T404X1A",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, INIT
    "T404X1D",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, SUBS
    "T404X1D",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, SUBS
    "T404X1S",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, SEQUELA
    "T404X1S",    # POISONING BY OTH SYNTHETIC NARCOTICS, ACCIDENTAL, SEQUELA
    "T404X2",    # POISONING BY OTH SYNTHETIC NARCOTICS, INTENTIONAL SELF-HARM
    "T404X2A",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, INIT
    "T404X2A",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, INIT
    "T404X2D",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, SUBS
    "T404X2D",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, SUBS
    "T404X2S",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, SEQUELA
    "T404X2S",    # POISONING BY OTH SYNTHETIC NARCOTICS, SELF-HARM, SEQUELA
