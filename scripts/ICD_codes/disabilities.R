################################################################################
################################################################################
### ICD10 Codes to Source for Eligibility Criteria
### Goes with 03_clean_tafiph.R
### Kat Hoffman, Dec 2022
################################################################################
################################################################################

# intellectual disability ICD10 codes - 
itlcdsbl_icds <- c(
...
# dementia/Alzheimer's ICD10 codes -- https://docs.google.com/spreadsheets/d/1CKEP5VCvD_Z9ENiZRHSaesh_Z7VEfV4fvG-bYjgw3WY/edit#gid=0
dementia_icds <- c(
            ...
            "G3182", #	LEIGH'S DISEASE
                   ...
                   "F015", # VASCULAR DEMENTIA
                   "F0150", # 	VASCULAR DEMENTIA WITHOUT BEHAVIORAL DISTURBANCE
                   "F0150", # 	VASCULAR DEMENTIA WITHOUT BEHAVIORAL DISTURBANCE
                   "F0151", # 	VASCULAR DEMENTIA WITH BEHAVIORAL DISTURBANCE
                   "F02", # DEMENTIA IN OTHER DISEASES CLASSIFIED ELSEWHERE
                   "F028", # DEMENTIA IN OTHER DISEASES CLASSIFIED ELSEWHERE
                   "F0280", # 	DEMENTIA IN OTH DISEASES CLASSD ELSWHR W/O BEHAVRL DISTURB
...
# Schizophrenia ICD 10 codes -- https://docs.google.com/spreadsheets/d/1Vq5TYGWeoBkr0DKrPyew4p-EL3QrY2mGqKK1Z86HDi8/edit#gid=0
schiz_icds <- c(
    "F20", #SCHIZOPHRENIA
...
# Speech disorder ICD9/10 codes -- Agnosia is the only one determined to be severe enough for exclusion criteria per Kara
speech_icds <- c(
  "R481" #AGNOSIA
)

# Cerebral palsy ICD10 codes - https://docs.google.com/spreadsheets/d/1ceLhpCVwiEh3fVzYiAjwWw2cCEedf-R9K3NewEQnUAo/edit
cerpals_icds <- c(
...
# Epilepsy ICD9/10 codes - https://docs.google.com/spreadsheets/d/1Ba8QGzKPc5_Ohp0mgMm4M5gthNZfkC9i6UtU59meCr0/edit#gid=0
epilepsy_icds <- c(
...
blindness_icds <- c("H540",	# BLINDNESS, BOTH EYES
                    "H540X33", #	BLINDNESS R EYE CATEGORY 3, BLINDNESS LEFT EYE CATEGORY 3
                    "H540X34", #	BLINDNESS R EYE CATEGORY 3, BLINDNESS LEFT EYE CATEGORY 4
                    "H540X35", #	BLINDNESS R EYE CATEGORY 3, BLINDNESS LEFT EYE CATEGORY 5
                    "H540X43", #	BLINDNESS R EYE CATEGORY 4, BLINDNESS LEFT EYE CATEGORY 3
                    "H540X44", #	BLINDNESS R EYE CATEGORY 4, BLINDNESS LEFT EYE CATEGORY 4
                    "H540X45", #	BLINDNESS R EYE CATEGORY 4, BLINDNESS LEFT EYE CATEGORY 5
                    "H540X53", #	BLINDNESS R EYE CATEGORY 5, BLINDNESS LEFT EYE CATEGORY 3
                    "H540X54", #	BLINDNESS R EYE CATEGORY 5, BLINDNESS LEFT EYE CATEGORY 4
                    "H540X55"  #	BLINDNESS R EYE CATEGORY 5, BLINDNESS LEFT EYE CATEGORY 5
)
...
#cancer_icd10 <- read_csv(here::here("icd_codes/cancer_icd10.csv"), col_names=F)
#cat(cancer_icd10$X1, sep = "\",\n\"")
#cat(cancer_icd10$X1, sep = "\",\"")
#nrow(cancer_icd10)

cancer_icds <-
  c("C000","C001","C002","C003","C004","C005","C006","C008","C009","C01","C020",
    ...
    "C441191","C441192","C44121","C44122","C441221","C441222","C44129","C441291","C441292",
    "C44131","C441321","C441322","C441391","C441392","C44191","C44192","C441921","C441922",
    "C44199","C441991","C441992","C44201","C44202","C44209","C44211","C44212","C44219",
    "C7A095","C7A095","C7A096","C7A096","C7A098","C7A1","C7A8","C7B00","C7B01","C7B02","C7B03",
    "C7B04","C7B09","C7B1","C7B8","C800","C801","C802","C8100","C8101","C8102","C8103","C8104",
    "C8105","C8106","C8107","C8108","C8109","C8110","C8110","C8111","C8111","C8112","C8112",
    "C8113","C8113","C8114","C8114","C8115","C8115","C8116","C8116","C8117","C8117","C8118",
    "C8118","C8119","C8119","C8120","C8120","C8121","C8121","C8122","C8122","C8123","C8123",
    "C8124","C8124","C8125","C8125","C8126","C8126","C8127","C8127","C8128","C8128","C8129",
    "C8129","C8130","C8130","C8131","C8131","C8132","C8132","C8133","C8133","C8134","C8134",
    "C8135","C8135","C8136","C8136","C8137","C8137","C8138","C8138","C8139","C8139","C8140",
    "C8140","C8141","C8141","C8142","C8142","C8143","C8143","C8144","C8144","C8145","C8145",
    "C8146","C8146","C8147","C8147","C8148","C8148","C8149","C8149","C8170","C8170","C8171",
    "C8171","C8172","C8172","C8173","C8173","C8174","C8174","C8175","C8175","C8176","C8176",
    "C8177","C8177","C8178","C8178","C8179","C8179","C8190","C8191","C8192","C8193","C8194",
    ...
    "C8474","C8475","C8476","C8477","C8478","C8479","C8490","C8491","C8492","C8493","C8494",
    "C8495","C8496","C8497","C8498","C8499","C84A0","C84A1","C84A2","C84A3","C84A4","C84A5",
    "C84A6","C84A7","C84A8","C84A9","C84Z0","C84Z1","C84Z2","C84Z3","C84Z4","C84Z5","C84Z6",
    "C84Z7","C84Z8","C84Z9","C8510","C8511","C8512","C8513","C8514","C8515","C8516","C8517",
    ...
    "C9001","C9002","C9010","C9011","C9012","C9020","C9021","C9022","C9030","C9031","C9032",
    "C9100","C9101","C9102","C9110","C9111","C9112","C9130","C9131","C9132","C9140","C9141",
    "C9142","C9150","C9151","C9152","C9160","C9161","C9162","C9190","C9191","C9192","C91A0",
    "C91A1","C91A2","C91Z0","C91Z1","C91Z2","C9200","C9201","C9202","C9210","C9211","C9212",
    "C9220","C9221","C9222","C9230","C9231","C9232","C9240","C9241","C9242","C9250","C9251",
    "C9252","C9260","C9261","C9262","C9290","C9291","C9292","C92A0","C92A1","C92A2","C92Z0",
    "C92Z1","C92Z2","C9300","C9301","C9302","C9310","C9311","C9312","C9330","C9331","C9332",
    "C9390","C9391","C9392","C93Z0","C93Z1","C93Z2","C9400","C9401","C9402","C9420","C9421",
    "C9422","C9430","C9431","C9432","C9440","C9441","C9442","C946","C9480","C9481","C9482",
    "C9500","C9501","C9502","C9510","C9511","C9512","C9590","C9591","C9592","C960","C962",
    "C9620","C9621","C9622","C9629","C964","C965","C966","C969","C96A","C96Z","D0000","D0001",
    "D0002","D0003","D0004","D0005","D0006","D0007","D0008","D001","D002","D010","D011","D012",
    "D013","D0140","D0149","D015","D017","D019","D020","D021","D0220","D0221","D0222","D023",
    "D024","D030","D0310","D0311","D03111","D03112","D0312","D03121","D03122","D0320","D0321",
    "D0322","D0330","D0339","D034","D0351","D0352","D0359","D0360","D0361","D0362","D0370","D0371",
    "D0372","D038","D039","D040","D0410","D0411","D04111","D04112","D0412","D04121","D04122","D0420",
    "D0421","D0422","D0430","D0439","D044","D045","D0460","D0461","D0462","D0470","D0471","D0472",
    "D048","D049","D0500","D0501","D0502","D0510","D0511","D0512","D0580","D0581","D0582","D0590",
    "D0591","D0592","D060","D061","D067","D069","D070","D071","D072","D0730","D0739","D074",
    "D075","D0760","D0761","D0769","D090","D0910","D0919","D0920","D0921","D0922","D093","D098","D099"
  )
